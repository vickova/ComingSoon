...
import GreenBackground from '../images/loan.png';
...
const LoanBackground = () => {
  return (
    <LoanBackgroundStyle GreenBackground={GreenBackground} Tilt={Tilt}>
...
const LoanBackgroundStyle = styled.div`
